...
{
    /**
     * @var integer Optional. Identifier of the first update to be returned.
    ...
    private $offset;
    /**
     * @var integer Optional. Limits the number of updates to be retrieved.
     * Values between 1—100 are accepted. Defaults to 100.
     */
    private $limit;
    /**
     * @var integer Optional. Timeout in seconds for long polling. Defaults to 0, i.e. usual short polling.
